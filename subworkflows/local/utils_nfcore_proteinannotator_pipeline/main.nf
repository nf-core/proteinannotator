...
def toolCitationText() {
    ...
    def domain_annotation_text = (params.skip_pfam && params.skip_funfam && params.skip_npmsfam) ? "" : "Domains were annotated with hmmer/hmmsearch (Eddy et al. 2011)."
...
def toolBibliographyText() {
    ...
    def domain_annotation_text = (params.skip_pfam && params.skip_funfam && params.skip_npmsfam) ? '' : '<li>Eddy, S. R. (2011). Accelerated profile HMM searches. PLoS computational biology, 7(10), e1002195. doi: <a href="https://doi.org/10.1371/journal.pcbi.1002195">10.1371/journal.pcbi.1002195</a></li>'
